...
Second, CRINK's informal cooperation, while fragmented, still poses a challenge. Through asymmetric tacticsÃ¢â‚¬â€such as cyberattacks, sanctions evasion, arms transfers, and disinformation campaignsÃ¢â‚¬â€these states can still undermine global norms and distract Western powers by igniting crises on multiple fronts simultaneously. The West, and indeed the Global South, must be alert not just to the actions of CRINK states, but to the conditions that enable them to act: instability, broken diplomacy, and economic fragmentation.

## Conclusion: Fragile Alliances, Not Fatal Threats

The CRINK bloc is more a geopolitical mirage than a durable axis. What unites China, Russia, Iran, and North Korea is not a grand design, but shared grievance and opportunism. As such, it should not be dismissedÃ¢â‚¬â€but neither should it be overestimated. For international relations scholars and emerging policy thinkers, including members of IRSAK, this case highlights the importance of examining alliances beyond surface-level narratives. Real power blocs are built on trust, coordination, and shared valuesÃ¢â‚¬â€not just mutual enemies.`
  ...
  },
  {
    ...
    fullContent: "This policy brief presents actionable recommendations drawn from a roundtable discussion convened by YIGA on 6th February 2026, pegged on strengthening youth participation in politics and governance. The event was attended by leading civil society organizations, researchers, university student leaders, and representatives from the National Youth Council and the Centre for Multiparty Democracy Kenya.\n\nKey Finding 1: Lack of Trust in Politicians and Political Institutions. Nearly 70% of respondents identified distrust in political leaders as a major reason for their limited engagement in formal political processes. An alarming 80% indicated that politicians do not care about the youth.\n\nKey Finding 2: A Small Fraction of the Demographic is Disinterested in Politics. 20% of respondents had no interest in politics and governance, negatively impacting their political awareness and participation.\n\nKey Finding 3: Limited Information on Political Activities Hinders Participation. Most respondents did not know where to get credible political information on public consultation processes and political party manifestos.\n\nKey Finding 4: Social Media Plays a Significant Role. 83% of students reported relying on social media as their primary source of information, with 70% preferring it for civic education initiatives.\n\nThe policy brief recommends that Political Parties clearly align their legislation to their manifestos, organize virtual forums, and communicate the benefits of party membership. The IEBC should better resource its youth committee and organize open house forums on electoral processes. Civil Society Organizations should champion joint civic education initiatives and collaborate on information dissemination strategies."
  }
];
...
const pastActivities = [
  ...
  },
  {
    ...
    image: "/images/activities/Research_Study_Launch.jpeg",
  ...
  },
  {
    ...
    image: "/images/activities/Official_Visit_to_UNDP.jpeg",
  ...
  },
  {
    ...
    image: "/images/activities/Official_Visit_To_Rwanda_Cooperation.jpeg",
  ...
  },
  {
    ...
    image: "/images/activities/Rountable_on_the_role_of_Youth_in_Peace_Building.jpeg",
  ...
  },
  {
    ...
    image: "/images/activities/UN_day_for_South-South_Cooperation.jpeg",
    category: "UN Event",
  ...
  },
  {
    ...
    image: "/images/activities/career_and_mentorship_forum.jpeg",
    category: "Mentorship",
  ...
  },
  {
    ...
    image: "/images/activities/East_African_Community_visit.jpeg",
  ...
  return (
    <div className="text-center bg-gray-50 rounded-xl p-6 hover:shadow-xl transition-all duration-300">
      <img
        src={advisor.photo}
        alt={advisor.name}
        className="w-32 h-32 rounded-full object-cover border-4 border-black shadow-lg mx-auto mb-4 cursor-pointer hover:border-red-600 transition duration-300"
      ...
      {showBio
        ...
        : <p className="text-gray-400 text-xs italic cursor-pointer" onClick={() => setShowBio(true)}>Click photo to view bio</p>
      }
    </div>
  );
};
function App() {
  ...
  const deleteAdmin = async (id) => {
    ...
    const admins_list = admins.find(a => a.id === id);
    if (admins_list && admins_list.username === "Shawn") { alert("This account cannot be deleted."); return; }
    try {
              ...
              <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
                <div className="max-w-3xl text-white">
                  ...
                  <p className="text-xl md:text-2xl mb-8 text-gray-200">
                    Empowering young professionals to drive meaningful change in international relations, governance, and policy across the Eastern Africa and beyond
                  </p>
                  ...
                  <div key={article.id} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition group">
                    ...
                    <div className="p-6">
                      <div className="flex items-center space-x-4 text-sm text-gray-500 mb-3">
                        ...
                        <span>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ {article.readTime}</span>
                      </div>
                ...
                <form onSubmit={handleNewsletterSubmit} className="max-w-md mx-auto">
                  ...
                  {newsletterStatus === 'success' && (
                    <div className="mt-4 bg-green-100 text-green-800 p-3 rounded-lg font-bold">
                      ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Successfully subscribed!
                    </div>
                  )}
                  {newsletterStatus === 'error' && (
                    <div className="mt-4 bg-red-100 text-red-800 p-3 rounded-lg font-bold">
                      ÃƒÂ¢Ã‚ÂÃ…â€™ Subscription failed. Please try again.
                    </div>
                  )}
                </form>
              </div>
          ...
          <div className="max-w-4xl mx-auto px-4 py-16">
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl mb-12">
              ...
              <form onSubmit={handleNewsletterPreferencesSubmit}>
                ...
                {newsletterStatus === 'success' && (
                  <div className="mt-4 bg-green-100 text-green-800 p-3 rounded-lg font-bold">
                    ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Successfully subscribed with your preferences!
                  </div>
                )}
                {newsletterStatus === 'error' && (
                  <div className="mt-4 bg-red-100 text-red-800 p-3 rounded-lg font-bold">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div>
                        ...
                        <ul className="text-gray-700 space-y-2">
                          <li>Ã¢â‚¬â€ Safe and moderated environment for open dialogue</li>
                          <li>Ã¢â‚¬â€ Critical engagement on leadership and public policy</li>
                          <li>Ã¢â‚¬â€ Platform to discuss accountability and democracy</li>
                          <li>Ã¢â‚¬â€ Understanding of peace and global affairs</li>
                          <li>Ã¢â‚¬â€ Respectful peer-to-peer learning experience</li>
                          <li>Ã¢â‚¬â€ Virtual accessibility from anywhere</li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div>
                        <h3 className="font-semibold text-lg text-red-600 mb-2">What You'll Gain</h3>
                        <ul className="text-gray-700 space-y-2">
                          <li>Ã¢â‚¬â€ Direct engagement with policymakers and experts</li>
                          <li>Ã¢â‚¬â€ Solution-oriented collaborative problem-solving</li>
                          <li>Ã¢â‚¬â€ Contribute to policy briefs and advocacy initiatives</li>
                          <li>Ã¢â‚¬â€ Participate in knowledge production and research</li>
                          <li>Ã¢â‚¬â€ Network with scholars and practitioners</li>
                          <li>Ã¢â‚¬â€ Influence practical ideas with policy-relevant impact</li>
                        </ul>
                      </div>
                    </div>
                    <div className="grid md:grid-cols-3 gap-4 bg-gray-50 p-4 rounded">
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl">
              {submitStatus === 'success' && (
                <div className="mb-6 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded">
                  ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Application submitted successfully!
                </div>
              )}
              {submitStatus === 'error' && (
                <div className="mb-6 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded">
                  ÃƒÂ¢Ã‚ÂÃ…â€™ Submission failed. Please try again.
                </div>
              )}
                          ...
                          {applications.filter(app => !searchQuery || app.full_name?.toLowerCase().includes(searchQuery.toLowerCase()) || app.email?.toLowerCase().includes(searchQuery.toLowerCase()) || app.country?.toLowerCase().includes(searchQuery.toLowerCase()) || app.status?.toLowerCase().includes(searchQuery.toLowerCase())).map((app) => (
                            <tr key={app.id} className="border-b hover:bg-gray-50">
                              ...
                              <td className="px-4 py-3">
                                <select
                                  value={app.status}
                                  onChange={(e) => updateApplicationStatus(app.id, e.target.value, app.email, app.full_name)}
